<?php
/* Smarty version 3.1.39, created on 2022-05-26 21:32:12
  from '/www/wwwroot/git/mm-acg-faka/app/View/Admin/Trade/Card.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_628f815c3064a9_00163309',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '121b0686d9c87ed8969229904f22227beebc0a01' => 
    array (
      0 => '/www/wwwroot/git/mm-acg-faka/app/View/Admin/Trade/Card.html',
      1 => 1653569340,
      2 => 'file',
    ),
  ),
...
function content_628f815c3064a9_00163309 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    $(function () {
        layui.use(['hex', 'form'], function () {
                        ...
                        events: {
                            'click .del': function (event, value, row, index) {
                                layer.confirm('您是否要移除该卡密，这是无法恢复的？', {
                                    ...
                                    $.post('/admin/api/card/del', {list: [row.id]}, res => {
                                        layer.msg(res.msg);
                            ...
                            'click .lock': function (event, value, row, index) {
                                $.post('/admin/api/card/edit', {id: row.id, status: 2}, res => {
                                    layer.msg(res.msg);
                                    table.bootstrapTable('refresh', {silent: true});
                                });
                            },
                            'click .unlock': function (event, value, row, index) {
                                $.post('/admin/api/card/edit', {id: row.id, status: 0}, res => {
                                    layer.msg(res.msg);
                                    table.bootstrapTable('refresh', {silent: true});
                                });
                            }
            ...
            cao.query('.search-query', table, [
                ...
                {title: "查询商品", name: "equal-commodity_id", type: "select", dict: "commodity->owner=0 and delivery_way=0 and (shared_id is null or shared_id=0),id,name", search: true},
