...
/* Smarty version 3.1.39, created on 2022-05-26 21:00:56
  from '/www/wwwroot/git/mm-acg-faka/app/View/Admin/Header.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_628f7a08535656_09542865',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b3ffa358ea1c2ab861ee96a0a9a239806e62b786' => 
    array (
      0 => '/www/wwwroot/git/mm-acg-faka/app/View/Admin/Header.html',
      1 => 1653569340,
      2 => 'file',
    ),
  ),
...
function content_628f7a08535656_09542865 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<!--begin::Head-->
<head>
...
-<?php echo $_smarty_tpl->tpl_vars['config']->value['title'];?>
    ...
    <link href="/assets/admin/plugins/global/plugins.bundle.css?v=<?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
" rel="stylesheet" type="text/css"/>
    <link href="/assets/admin/css/style.bundle.css?v=<?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
" rel="stylesheet" type="text/css"/>
    <!--end::Global Stylesheets Bundle-->
    <!--layui-->
    <link rel="stylesheet" href="/assets/static/layui/css/layui.css?v=<?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
">
    <?php echo '<script'; ?>
 src="/assets/static/jquery.min.js?v=<?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
"><?php echo '</script'; ?>
>
    <!-- Latest compiled and minified CSS -->
    <link rel="stylesheet" href="/assets/static/bootstrap-table/css/bootstrap-table.css?v=<?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
">
...
>
    ...
    <!--echarts-->
    <?php echo '<script'; ?>
 src="/assets/static/echarts.min.js"><?php echo '</script'; ?>
>
    <!--start::HOOK-->
...
<body id="kt_body"
      ...
      style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px;background: url('<?php echo $_smarty_tpl->tpl_vars['config']->value['background_url'];?>
        ...
        <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                ...
                <a href="javascript:void(0)">
                    <span class="h-25px logo fs-4 fw-bolder" style="color: pink;"><?php echo $_smarty_tpl->tpl_vars['config']->value['shop_name'];?>
</span>
                </a>
                <!--end::Logo-->
                <!--begin::Aside toggler-->
            ...
            <div class="aside-menu flex-column-fluid">
                ...
                <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if ($_smarty_tpl->tpl_vars['title']->value == '控制台') {?>active<?php }?>" href="/admin/dashboard/index">
...
<path opacity="0.3"
      ...
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '会员管理') {?>active<?php }?>" href="/admin/user/index">
										<span class="menu-icon">
...
<rect opacity="0.3" x="8" y="3" width="8" height="8" rx="4" fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '充值订单') {?>active<?php }?>" href="/admin/recharge/order">
										<span class="menu-icon">
                                               <!--begin::Svg Icon | path: assets/media/icons/duotune/finance/fin005.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
...
<path d="M18.5 11C18.5 10.2 17.8 9.5 17 9.5C16.2 9.5 15.5 10.2 15.5 11C15.5 11.4 15.7 11.8 16 12.1V13C16 13.6 16.4 14 17 14C17.6 14 18 13.6 18 13V12.1C18.3 11.8 18.5 11.4 18.5 11Z"
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '账单管理') {?>active<?php }?>" href="/admin/user/bill">
										<span class="menu-icon">
...
<path d="M9.2 12.9C9.1 12.8 9.10001 12.7 9.10001 12.6C9.00001 12.2 9.3 11.7 9.7 11.6C10.1 11.5 10.6 11.8 10.7 12.2C10.7 12.3 10.7 12.4 10.7 12.5L9.2 12.9ZM14.8 12.9C14.9 12.8 14.9 12.7 14.9 12.6C15 12.2 14.7 11.7 14.3 11.6C13.9 11.5 13.4 11.8 13.3 12.2C13.3 12.3 13.3 12.4 13.3 12.5L14.8 12.9ZM16 7.29998C16.3 6.99998 16.5 6.69998 16.7 6.29998C16.3 6.29998 15.8 6.30001 15.4 6.20001C15 6.10001 14.7 5.90001 14.4 5.70001C13.8 5.20001 13 5.00002 12.2 4.90002C9.9 4.80002 8.10001 6.79997 8.10001 9.09997V11.4C8.90001 10.7 9.40001 9.8 9.60001 9C11 9.1 13.4 8.69998 14.5 8.29998C14.7 9.39998 15.3 10.5 16.1 11.4V9C16.1 8.5 16 8 15.8 7.5C15.8 7.5 15.9 7.39998 16 7.29998Z"
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '会员等级') {?>active<?php }?>" href="/admin/user/group">
										<span class="menu-icon">
                                              <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs038.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
...
<path opacity="0.3"
      ...
      fill="black"/>
                                ...
                                <span class="menu-title">会员等级</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '商户等级') {?>active<?php }?>" href="/admin/user/businessLevel">
										<span class="menu-icon">
...
<path d="M11.0697 2.75L7.46973 13.95L16.9697 20.85C17.8697 21.45 18.9697 20.65 18.6697 19.65L13.1697 2.75C12.7697 1.75 11.3697 1.75 11.0697 2.75Z"
      fill="black"/>
                                ...
                                <span class="menu-title">商户等级</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '提现管理') {?>active<?php }?>" href="/admin/cash/index">
										<span class="menu-icon">
                                         <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen023.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
...
<rect x="7" y="11" width="2.6" height="2.6" rx="1.3" fill="black"/>
                                ...
                                <span class="menu-title">提现管理</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <div class="menu-content pt-8 pb-2">
                                <span class="menu-section text-muted text-uppercase fs-8 ls-1">Trade</span>
                            </div>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '分类管理') {?>active<?php }?>" href="/admin/category/index">
										<span class="menu-icon">
                                                <span class="svg-icon svg-icon-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '商品管理') {?>active<?php }?>" href="/admin/commodity/index">
										<span class="menu-icon">
                                                <span class="svg-icon svg-icon-2"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none">
...
<path d="M11.325 17.525C10.025 18.025 8.425 17.725 7.325 16.725C5.825 15.225 5.825 12.925 7.325 11.425C8.825 9.92498 11.125 9.92498 12.625 11.425C13.225 12.025 13.625 12.925 13.725 13.725C14.825 13.825 15.925 13.525 16.725 12.625C17.125 12.225 17.425 11.825 17.525 11.325C17.125 10.225 16.525 9.22498 15.625 8.42498C12.525 5.32498 7.425 5.32498 4.325 8.42498C1.225 11.525 1.225 16.625 4.325 19.725C7.425 22.825 12.525 22.825 15.625 19.725C16.325 19.025 16.925 18.225 17.225 17.325C15.425 18.125 13.225 18.225 11.325 17.525Z"
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '卡密管理') {?>active<?php }?>" href="/admin/card/index">
										<span class="menu-icon">
                                                <!--begin::Svg Icon -->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
...
<path opacity="0.3"
      ...
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '优惠卷') {?>active<?php }?>" href="/admin/coupon/index">
										<span class="menu-icon">
                                               <!--begin::Svg Icon | path: assets/media/icons/duotune/medicine/med009.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
...
<path opacity="0.3"
      ...
      fill="black"/>
                        ...
                        <div class="menu-item">
                            <div class="menu-content pt-8 pb-2">
                                <span class="menu-section text-muted text-uppercase fs-8 ls-1">Shared</span>
                            </div>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '店铺共享') {?>active<?php }?>" href="/admin/store/index">
										<span class="menu-icon">
...
<path d="M17.5 16C17.5 16 17.4 16 17.5 16L16.7 15.3C16.1 14.7 15.7 13.9 15.6 13.1C15.5 12.4 15.5 11.6 15.6 10.8C15.7 9.99999 16.1 9.19998 16.7 8.59998L17.4 7.90002H17.5C18.3 7.90002 19 7.20002 19 6.40002C19 5.60002 18.3 4.90002 17.5 4.90002C16.7 4.90002 16 5.60002 16 6.40002V6.5L15.3 7.20001C14.7 7.80001 13.9 8.19999 13.1 8.29999C12.4 8.39999 11.6 8.39999 10.8 8.29999C9.99999 8.19999 9.20001 7.80001 8.60001 7.20001L7.89999 6.5V6.40002C7.89999 5.60002 7.19999 4.90002 6.39999 4.90002C5.59999 4.90002 4.89999 5.60002 4.89999 6.40002C4.89999 7.20002 5.59999 7.90002 6.39999 7.90002H6.5L7.20001 8.59998C7.80001 9.19998 8.19999 9.99999 8.29999 10.8C8.39999 11.5 8.39999 12.3 8.29999 13.1C8.19999 13.9 7.80001 14.7 7.20001 15.3L6.5 16H6.39999C5.59999 16 4.89999 16.7 4.89999 17.5C4.89999 18.3 5.59999 19 6.39999 19C7.19999 19 7.89999 18.3 7.89999 17.5V17.4L8.60001 16.7C9.20001 16.1 9.99999 15.7 10.8 15.6C11.5 15.5 12.3 15.5 13.1 15.6C13.9 15.7 14.7 16.1 15.3 16.7L16 17.4V17.5C16 18.3 16.7 19 17.5 19C18.3 19 19 18.3 19 17.5C19 16.7 18.3 16 17.5 16Z"
      fill="black"/>
                                ...
                                <span class="menu-title">店铺共享</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <div class="menu-content pt-8 pb-2">
                                <span class="menu-section text-muted text-uppercase fs-8 ls-1">Config</span>
                            </div>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '网站设置') {?>active<?php }?>" href="/admin/config/index">
										<span class="menu-icon">
...
<path d="M17.1 12.1C17.1 14.9 14.9 17.1 12.1 17.1C9.30001 17.1 7.10001 14.9 7.10001 12.1C7.10001 9.29998 9.30001 7.09998 12.1 7.09998C14.9 7.09998 17.1 9.29998 17.1 12.1ZM12.1 10.1C11 10.1 10.1 11 10.1 12.1C10.1 13.2 11 14.1 12.1 14.1C13.2 14.1 14.1 13.2 14.1 12.1C14.1 11 13.2 10.1 12.1 10.1Z"
      fill="black"/>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['user']->value['type'] == 0 || $_smarty_tpl->tpl_vars['user']->value['type'] == 1) {?>
                            <div class="menu-item">
                                <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '管理员') {?>active<?php }?>" href="/admin/manage/index">
										<span class="menu-icon">
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '通用插件') {?>active<?php }?>" href="/admin/plugin/index">
										<span class="menu-icon">
                                       <!--begin::Svg Icon | path: assets/media/icons/duotune/social/soc005.svg-->
<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                       fill="none">
<path opacity="0.3"
...
<path d="M12 17.5026C8.9 17.5026 6.39999 15.0026 6.39999 11.9026C6.39999 8.80259 8.9 6.30261 12 6.30261C15.1 6.30261 17.6 8.80259 17.6 11.9026C17.6 15.0026 15.1 17.5026 12 17.5026ZM12 8.30261C10 8.30261 8.39999 9.90259 8.39999 11.9026C8.39999 13.9026 10 15.5026 12 15.5026C14 15.5026 15.6 13.9026 15.6 11.9026C15.6 9.90259 14 8.30261 12 8.30261Z"
      fill="black"/>
                                ...
                                <span class="menu-title">通用插件</span>
                            </a>
                        </div>

                        <div data-kt-menu-trigger="click"
                             class="menu-item menu-accordion <?php if (in_array($_smarty_tpl->tpl_vars['title']->value,array('支付插件','支付设置'))) {?> here show <?php }?>">
...
<path opacity="0.3"
      ...
      fill="black"/>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link <?php if ($_smarty_tpl->tpl_vars['title']->value == '支付插件') {?>active<?php }?>" href="/admin/pay/plugin">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                        <span class="menu-title">支付插件</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link <?php if ($_smarty_tpl->tpl_vars['title']->value == '支付设置') {?>active<?php }?>" href="/admin/pay/index">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                        <span class="menu-title">支付接口</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['user']->value['type'] == 0) {?>
                            <div class="menu-item">
                                <a class="menu-link  <?php if ($_smarty_tpl->tpl_vars['title']->value == '操作日志') {?>active<?php }?>" href="/admin/log/index">
										<span class="menu-icon">
                                           <!--begin::Svg Icon | path: assets/media/icons/duotune/technology/teh002.svg-->
...
<path d="M9.2 12.9C9.1 12.8 9.10001 12.7 9.10001 12.6C9.00001 12.2 9.3 11.7 9.7 11.6C10.1 11.5 10.6 11.8 10.7 12.2C10.7 12.3 10.7 12.4 10.7 12.5L9.2 12.9ZM14.8 12.9C14.9 12.8 14.9 12.7 14.9 12.6C15 12.2 14.7 11.7 14.3 11.6C13.9 11.5 13.4 11.8 13.3 12.2C13.3 12.3 13.3 12.4 13.3 12.5L14.8 12.9ZM16 7.29998C16.3 6.99998 16.5 6.69998 16.7 6.29998C16.3 6.29998 15.8 6.30001 15.4 6.20001C15 6.10001 14.7 5.90001 14.4 5.70001C13.8 5.20001 13 5.00002 12.2 4.90002C9.9 4.80002 8.10001 6.79997 8.10001 9.09997V11.4C8.90001 10.7 9.40001 9.8 9.60001 9C11 9.1 13.4 8.69998 14.5 8.29998C14.7 9.39998 15.3 10.5 16.1 11.4V9C16.1 8.5 16 8 15.8 7.5C15.8 7.5 15.9 7.39998 16 7.29998Z" fill="black"/>
                        ...
                        <?php if (getHookNum(\App\Consts\Hook::ADMIN_VIEW_MENU) > 0) {?>
                            <div class="menu-item">
                                <div class="menu-content pt-8 pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">Plugin</span>
                                </div>
                            </div>
                        <?php }?>
                        <!--start::HOOK-->
                        ...
                        <div class="menu-item">
                            <a class="menu-link">
                                ...
                                <span class="menu-title latest-update" style="font-size: 12px;"><span
                                            class="local-version"><?php echo $_smarty_tpl->tpl_vars['app']->value['version'];?>
</span> <b style="margin-left: 5px;"
                                                                                            class="latest-version"></b></span>
                            </a>
                        </div>
                    </div>
                    <!--end::Menu-->
                            ...
                            <div class="header-menu">
                                <?php if ($_smarty_tpl->tpl_vars['_store_initialize']->value) {?>
                                    ...
                                    <div class="menu me-4 menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch">
                                        <div class="menu-item me-lg-1 app-store"><a class="py-3 text-success fw-bold"
                                                                                    href="/admin/store/home"><i
                                                        class="fab fa-app-store-ios fs-5 pt-1 text-success"></i> 应用商店</a>
                                                <select style="border: none;font-size: 12px;color: dodgerblue;background: rgba(255,255,255,0);" class="app-server-select"><option value="0" <?php if ($_smarty_tpl->tpl_vars['app']->value['server'] == 0) {?> selected <?php }?>>国内线路-1</option><option value="3" <?php if ($_smarty_tpl->tpl_vars['app']->value['server'] == 3) {?> selected <?php }?>>通用节点-1</option><option value="1" <?php if ($_smarty_tpl->tpl_vars['app']->value['server'] == 1) {?> selected <?php }?>>海外线路-1</option><option value="2" <?php if ($_smarty_tpl->tpl_vars['app']->value['server'] == 2) {?> selected <?php }?>>海外线路-2</option></select>
                                            <span class="store-text"></span></div>
                                    </div>
                                <?php } else { ?>
                                    <div class="menu me-4 menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch">
                                        <div class="menu-item me-lg-1 app-store"><a class="py-3 text-danger fw-bold"
                                                                                    href="javascript:layer.msg('您已离线，无法再使用应用商店。');"><i
                                                        class="fas fa-plug text-danger"></i> 离线版
                                            </a></div>
                                    </div>
                                <?php }?>
                                <!--end::Menu-->
                                <!--start::HOOK-->
                                <?php echo hook(\App\Consts\Hook::ADMIN_VIEW_NAV);?>
